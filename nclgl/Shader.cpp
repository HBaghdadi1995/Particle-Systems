...
GlShader::GlShader(string vFile, string fFile, string gFile) {
...
bool	GlShader::LoadShaderFile(string from, string &into) {
	ifstream	file;
	string		temp;
...
GLuint	GlShader::GenerateShader(string from, GLenum type) {
...
void	GlShader::SetDefaultAttributes() {
