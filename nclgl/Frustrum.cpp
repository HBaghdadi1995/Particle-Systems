...
void Frustrum::FromMatrix(const Matrix4 &mat) {
	...
	//BOTTOM
	planes[2] = Plane(waxis + yaxis, (mat.values[15] + mat.values[12]), true);
	//TOP
	planes[3] = Plane(waxis - yaxis, (mat.values[15] - mat.values[12]), true);
	//FAR
	planes[4] = Plane(waxis - zaxis, (mat.values[15] - mat.values[12]), true);
	//NEAR
	planes[5] = Plane(waxis + zaxis, (mat.values[15] + mat.values[12]), true);
}